...
<template>
  <div class="flex justify-between px-96 py-24 gap-10">
    <div class="flex-1">
      <figure>
        <h1 class="text-5xl font-semibold ">Rengga Maulana</h1>
        <h2 class="my-4 font-semibold text-lg">Full Stack Engineer</h2>
        <p class="w-3/4 font-light">I create end-to-end digital experiences that are intuitive, accessible, and built to last.</p>
      </figure>
    </div>
    <div class="flex-1">
      <!-- about -->
